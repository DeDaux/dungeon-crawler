    ...
    for col in range(cols):
        ...
        for y in range(frame_h):
            for x in range(frame_w):
                ...
                # Wipe the outer 8 pixels of the 1/16th cell to destroy the AI border
    ...
    if os.path.exists(folder_path):
        for filename in os.listdir(folder_path):
            if filename in clean_frames:
                ...
                print(f"Removed borders for {filename} in {folder}")
    ...
    if os.path.exists(src_path) and os.path.exists(dest_path):
        for filename in os.listdir(src_path):
            ...
            if os.path.exists(s_file):
                ...
                print(f"Removed borders for {filename} in {dest_folder}")

print("Borders completely removed!")
