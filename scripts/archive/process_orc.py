...
out_dir = r"C:\Users\bauzy\.gemini\antigravity\scratch\Sprites\Orc\Frames"

os.makedirs(out_dir, exist_ok=True)
shutil.copy(src_img, r"C:\Users\bauzy\.gemini\antigravity\scratch\Sprites\Orc\orc_sprite_sheet.png")
...
for row in range(rows):
    for col in range(cols):
        ...
        frame_path = os.path.join(out_dir, f"orc_frame_{frame_idx:02d}.png")
        frame.save(frame_path, "PNG")
        frame_idx += 1

print("Orc frames processed successfully!")
